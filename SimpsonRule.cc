...
/*
 *  Function Declaration for the Simpson 1/3  rule. This function will
 *  will return the integral of function $f$ in the interval [a,b] using
 *  composite Simpson rule
 *
 */
double Integral_by_Simpson_1by3_Rule(const vector<double>& , double , double, int);
...
int main(){
   ...
   */
  int b =2.0*M_PI;  // end point of the interval
  ...
  std::cout<<"==========================Error Report for Simpson Rule====================="<<std::endl;
 ...
 std::cout<<"------------------------------------------------------------------------------"<<std::endl;
  ...
  /*
   * approx_integ: approximate integral obtained by Simpson rule 
   *
   *  Integral_by_Simpson_1by3_Rule(f,a,b,N): this function will compute 
  ...
  double approx_integ =  Integral_by_Simpson_1by3_Rule(f,a,b,N);
...
double Integral_by_Simpson_1by3_Rule(const vector<double>& f, double a, double b, int N)
{
  //int N =f.size()-1 ;
